<template>
  <div class="w-full h-full flex flex-col-reverse justify-center md:grid grid-cols-3 gap-x-6 items-center">
    <div class="col-start-1 col-end-3 text-center md:rtl:text-right  md:ltr:text-left mt-8 md:mt-0">
      <h2 class="text-3xl mb-6 font-extrabold text-brand-3">
        {{ $t("title") }}
      </h2>
      <p class="text-brand-5 text-lg mb-8 max-w-xl">
        {{ $t("description") }}
      </p>
      <div class="flex gap-x-6 justify-center md:justify-start">
        <button
          class="
            bg-brand-7
            flex
    ...
    <div class="w-full md:w-auto flex md:block justify-center">
      <div
        class="
          aspect-square
          bg-brand-5
          md:rounded-[60px] rounded-[45px]
          overflow-hidden
          w-full
          max-w-[400px]
          md:p-10 p-6 md:ltr:ml-auto md:rtl:mr-auto
        "
      >
        <div class="w-full h-full bg-brand-6 md:rounded-[60px] rounded-[20px] flex">
          <span class="m-auto text-brand-5 text-2xl">Main Image</span>
        </div>
      </div>
    </div>
  </div>
